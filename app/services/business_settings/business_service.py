...
class BusinessSettingService(business_setting_pb2_grpc.BusinessSettingServicer):
    def table(self, request, context):
        try:
            ...
            is_auth(auth_token, '100_business_setting_table')
    ...
    def get_all(self, request, context):
        try:
            auth_token = parser_context(context, 'auth_token')
            is_auth(auth_token, '100_business_setting_get_all')
    ...
    def get(self, request, context):
        try:
            auth_token = parser_context(context, 'auth_token')
            is_auth(auth_token, '100_business_setting_get')
    ...
    def save(self, request, context):
        try:
            auth_token = parser_context(context, 'auth_token')
            is_auth(auth_token, '100_business_setting_save')
    ...
    def update(self, request, context):
        try:
            auth_token = parser_context(context, 'auth_token')
            is_auth(auth_token, '100_business_setting_update')
    ...
    def delete(self, request, context):
        try:
            auth_token = parser_context(context, 'auth_token')
            is_auth(auth_token, '100_business_setting_delete')
